...
int main(void)
{
  POWER_MODE_TYPE power_type = GO_MODE;
  ...
  {
        case GO_MODE: 
          SERVICES_test_go(services_handle,power_mode_input,powermodes[power_type_input-1]);
          break;
        case READY_MODE:
          SERVICES_test_ready(services_handle,power_mode_input,powermodes[power_type_input-1]);
          break;
        case IDLE_MODE:
          SERVICES_test_idle(services_handle,power_mode_input,powermodes[power_type_input-1]);
          break;
        case STANDBY_MODE:
          SERVICES_test_standby(services_handle,power_mode_input,powermodes[power_type_input-1]);
          break;
        case STOP_MODE:
          SERVICES_test_stop(services_handle,power_mode_input,powermodes[power_type_input-1]);
          break;
        default:
          break;
  }
